...
namespace GradingSystem {
    ...
    public partial class GradingSystemDataSet3 : global::System.Data.DataSet {
        ...
        public partial class CourseInfoDataTable : global::System.Data.TypedTableBase<CourseInfoRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public CourseInfoRow AddCourseInfoRow(string CourseId, string Title, string Teacher, string Credit) {
        ...
        public partial class CourseInfoRow : global::System.Data.DataRow {
            ...
            public string Title {
                get {
                    return ((string)(this[this.tableCourseInfo.TitleColumn]));
                }
                set {
                    this[this.tableCourseInfo.TitleColumn] = value;
                }
            }
...
namespace GradingSystem.GradingSystemDataSet3TableAdapters {
    ...
    public partial class CourseInfoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[CourseInfo] WHERE (([CourseId] = @Original_CourseId) AND ([Tit" +
                "le] = @Original_Title) AND ([Teacher] = @Original_Teacher) AND ([Credit] = @Orig" +
                "inal_Credit))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[CourseInfo] ([CourseId], [Title], [Teacher], [Credit]) VALUES " +
                "(@CourseId, @Title, @Teacher, @Credit);\r\nSELECT CourseId, Title, Teacher, Credit" +
                " FROM CourseInfo WHERE (CourseId = @CourseId)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[CourseInfo] SET [CourseId] = @CourseId, [Title] = @Title, [Teacher] = @Teacher, [Credit] = @Credit WHERE (([CourseId] = @Original_CourseId) AND ([Title] = @Original_Title) AND ([Teacher] = @Original_Teacher) AND ([Credit] = @Original_Credit));
SELECT CourseId, Title, Teacher, Credit FROM CourseInfo WHERE (CourseId = @CourseId)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT CourseId, Title, Teacher, Credit FROM dbo.CourseInfo";
        ...
        public virtual int Fill(GradingSystemDataSet3.CourseInfoDataTable dataTable) {
        ...
        public virtual GradingSystemDataSet3.CourseInfoDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            GradingSystemDataSet3.CourseInfoDataTable dataTable = new GradingSystemDataSet3.CourseInfoDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(GradingSystemDataSet3.CourseInfoDataTable dataTable) {
        ...
        public virtual int Delete(string Original_CourseId, string Original_Title, string Original_Teacher, string Original_Credit) {
            ...
            if ((Original_Credit == null)) {
                throw new global::System.ArgumentNullException("Original_Credit");
            }
            else {
                this.Adapter.DeleteCommand.Parameters[3].Value = ((string)(Original_Credit));
            }
        ...
        public virtual int Insert(string CourseId, string Title, string Teacher, string Credit) {
            if ((CourseId == null)) {
        ...
        public virtual int Update(string CourseId, string Title, string Teacher, string Credit, string Original_CourseId, string Original_Title, string Original_Teacher, string Original_Credit) {
            if ((CourseId == null)) {
                throw new global::System.ArgumentNullException("CourseId");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Title, string Teacher, string Credit, string Original_CourseId, string Original_Title, string Original_Teacher, string Original_Credit) {
            return this.Update(Original_CourseId, Title, Teacher, Credit, Original_CourseId, Original_Title, Original_Teacher, Original_Credit);
        }
    }
